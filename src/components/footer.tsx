...
const ThreadsIcon = ({ className }: { className?: string }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 192" fill="currentColor">
      ...
      <div className="mx-auto flex max-w-[90rem] flex-col gap-8 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <div className="mt-6 flex flex-wrap gap-6 text-sm font-medium">
            <a href="https://threads.net/@RasenganTrader" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[color:var(--color-ink-soft)] hover:text-foreground transition-colors">
              <ThreadsIcon className="size-4" />
              Threads
            </a>
            <a href="https://tiktok.com/@RasenganTrader" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[color:var(--color-ink-soft)] hover:text-foreground transition-colors">
              <TiktokIcon className="size-4" />
              TikTok
            </a>
            <a href="https://youtube.com/@RasenganTrader" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[color:var(--color-ink-soft)] hover:text-foreground transition-colors">
